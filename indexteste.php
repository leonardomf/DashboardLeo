...
<br />
<center><h1><strong><img src="/imagens/outros/lnv1183745848218930.png" width="200" class='animated fadeindown'/><strong></h1></center>
<br />
...
<div class='col_onsite' style="height:920px;">
<br />
<?php
error_reporting(0);
header('Content-Type: text/html; charset=UTF-8' );
...
$analistasonsite=array("Sylverio, Bruno Luis","da Silva, Carlos Eduardo","Moreno Peixoto, George","Rodrigues Lucena, Joel","Barros, Leonardo",utf8_decode("Mendonça Marques, Leonardo"),"Almeida, Marcos","Lima, Pablo","Sales, Victor"); 
...
<p>Incidentes</p>
<div class="barra_sla_cump" style="width:<?php echo $percent_sla_inc_sede_pg*2;?>px;"><span class="spanslacump"><?php echo $percent_sla_inc_sede_pg."%";?></div>
<div class="barra_sla_vio" style="width:<?php echo (100-$percent_sla_inc_sede_pg)*2;?>px;"><span class="spanslavio"><?php echo (100-$percent_sla_inc_sede_pg)."%";?></span></div>
<br /><br /><br />
<p>Requisições</p>
<div class="barra_sla_cump" style="width:<?php echo $percent_sla_dem_sede_pg*2;?>px;"><span class="spanslacump"><?php echo $percent_sla_dem_sede_pg."%";?></div>
<div class="barra_sla_vio" style="width:<?php echo (100-$percent_sla_dem_sede_pg)*2;?>px;"><span class="spanslavio"><?php echo (100-$percent_sla_dem_sede_pg)."%";?></span></div>
<br /><br /><br /><br />

<span class="titleeq"><p><strong><b>REDAÇÃO O GLOBO + EXTRA</b></strong></p></span>
<p>Incidentes</p>
<div class="barra_sla_cump" style="width:<?php echo $percent_sla_inc_globo_extra*2;?>px;"><span class="spanslacump"><?php echo $percent_sla_inc_globo_extra."%";?></div>
<div class="barra_sla_vio" style="width:<?php echo (100-$percent_sla_inc_globo_extra)*2;?>px;"><span class="spanslavio"><?php echo (100-$percent_sla_inc_globo_extra)."%";?></span></div>
<br /><br /><br />
<p>Requisições</p>
<div class="barra_sla_cump" style="width:<?php echo $percent_sla_dem_globo_extra*2;?>px;"><span class="spanslacump"><?php echo $percent_sla_dem_globo_extra."%";?></div>
<div class="barra_sla_vio" style="width:<?php echo (100-$percent_sla_dem_globo_extra)*2;?>px;"><span class="spanslavio"><?php echo (100-$percent_sla_dem_globo_extra)."%";?></span></div>
<br /><br /><br />
...
<span class="titleeq"><p><strong><b>REDAÇÃO O GLOBO</b></strong></p></span>
<p>Incidentes</p>
...
<span class="titleeq"><p><strong><b>REDAÇÃO EXTRA</b></strong></p></span>
<p>Incidentes</p>
...
if($planilhasc->val($i, 17)<>"Cancelado" and $planilhasc->val($i, 8)==="Resolvido" || $planilhasc->val($i, 8)==="Fechado"){


//if ($planilhasc->val($i, 5)===""){echo $planilhasc->val($i, 16);}else{echo $planilhasc->val($i, 5);}
$dataString=$planilhasc->val($i, 4);
$data1 = DateTime::createFromFormat('d/m/Y H:i', $dataString);

//$dataString2=$planilhasc->val($i, 5);
if($dataString2 === ""){
$dataString2 = $planilhasc->val($i, 16);
}
else{
$dataString2 = $planilhasc->val($i, 5);
}

$data2 = DateTime::createFromFormat('d/m/Y H:i', $dataString2);

$data1=date('Y-m-d H:i');
$data2=date('Y-m-d H:i');
$dataini=strtotime($data1);
$datafim=strtotime($data2);

//echo $data1->format('Y-m-d')."<br />";
echo '<table style="border:1px solid #000;width:350px;"><tr style="border:1px solid #000;"><td>';
echo $dataString."</td><td>";

echo $dataString2."</td><td>";
$output = (strtotime($dataString2) - strtotime($dataString))/60;
$diffHoras = date('H:i', $output)/60;
