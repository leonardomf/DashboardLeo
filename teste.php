...
<div class="menu" style="display:none;position:absolute;background:#FFF;height:100%;width:250px;margin:0px;top:0px;left:-300px;z-index:999999999999999999999999999999;box-shadow:2px 5px 5px 3px rgba(0,0,0,0.15);">
<br><br>
...
<div class="content" style="position:relative;z-index:999999;width:470px;top:30;left:5px;">
...
<span style="position:absolute;margin-top:36px;background:#222;width:440px;height:50px;color:#fff;text-align:center;line-height:43px;">Notificacoes<span class='result number'></span></span>
<span style="position:absolute;margin-top:89px;background:#222;width:440px;height:50px;color:#fff;text-align:center;line-height:43px;">Alterar Status</span>
<span style="position:absolute;margin-top:142px;background:#222;width:440px;height:50px;color:#fff;text-align:center;line-height:43px;">Configuracoes</span>
<span style="position:absolute;margin-top:195px;background:#222;width:440px;height:50px;color:#fff;text-align:center;line-height:43px">Sair</span>
</div>




		<div class="photo_perfil" style="position:absolute;z-index:999999;width:35px;margin-left:55px;border:0px solid #F00;"><img src="Imagens/eu.jpg" width="28" style="border:2px solid #FFF;line-height:35px;border-radius: 50px;margin-left:0;"></div>
