...
for( $j=0; $j <=$quant_sla_inc_onsite_globo-1; $j++ ){
		if($planilhasc->val($i, 9)==="SC - On-Site Services Globo" and substr($planilhasc->val($i, 1), 0, 3)==="300" and $planilhasc->val($i, 17)<>"Cancelado" and $planilhasc->val($i, 8)==="Resolvido" || $planilhasc->val($i, 8)==="Fechado"){
...
/*SLA SOBRE INCIDENTES*/
if(substr($planilhasc->val($i, 1), 0, 3)==="300" and $planilhasc->val($i, 17)<>"Cancelado" and $planilhasc->val($i, 9)==="SC - On-Site Services Globo" and $planilhasc->val($i, 8)==="Resolvido" || $planilhasc->val($i, 8)==="Fechado" and $planilhasc->val($i, 11)==="Within SLA" || $planilhasc->val($i, 11)==="SLA Not Applied" ){
...
// || substr($planilhasc->val($i, 1), 0, 3)==="500"
if(substr($planilhasc->val($i, 1), 0, 3)==="100" and $planilhasc->val($i, 17)<>"Cancelado" and $planilhasc->val($i, 9)==="SC - On-Site Services Globo" and $planilhasc->val($i, 8)==="Resolvido" || $planilhasc->val($i, 8)==="Fechado"){
...
//|| substr($planilhasc->val($i, 1), 0, 3)==="500"
if(substr($planilhasc->val($i, 1), 0, 3)==="100" and $planilhasc->val($i, 17)<>"Cancelado" and $planilhasc->val($i, 9)==="SC - On-Site Services Globo" and $planilhasc->val($i, 11)==="Within SLA" || $planilhasc->val($i, 11)==="SLA Not Applied" and $planilhasc->val($i, 8)==="Resolvido" || $planilhasc->val($i, 8)==="Fechado"){
...
// || substr($planilhasc->val($i, 1), 0, 3)==="500"
if(substr($planilhasc->val($i, 1), 0, 3)==="500" and $planilhasc->val($i, 17)<>"Cancelado" and $planilhasc->val($i, 9)==="SC - On-Site Services Globo" and $planilhasc->val($i, 8)==="Resolvido" || $planilhasc->val($i, 8)==="Fechado"){
...
//|| substr($planilhasc->val($i, 1), 0, 3)==="500"
if(substr($planilhasc->val($i, 1), 0, 3)==="500" and $planilhasc->val($i, 17)<>"Cancelado" and $planilhasc->val($i, 9)==="SC - On-Site Services Globo" and $planilhasc->val($i, 11)==="Within SLA" || $planilhasc->val($i, 11)==="SLA Not Applied" and $planilhasc->val($i, 8)==="Resolvido" || $planilhasc->val($i, 8)==="Fechado"){
...
/*CALCULO TAREFAS*/
$valor_tarefa_onsite_globo_extra=$valor_tarefa_onsite_globo+$valor_tarefa_onsite_extra;
